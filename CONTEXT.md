...
- 콘도르 10초 무점프(차지 포함) 후 강하. 그 맵에 콘도르가 없으면 화면 밖에서 날아든다. 강하 4초
- 바람 구간 높이 합은 전체의 15%(맵 04·06·08, 각 400px, 왼쪽 214px). 강한 바람 소리는 구간 안 30%
- 타이틀은 title.png를 로고·시작·도움말로 나눠 0초·1초·2초에 아래에서 올라온다. 흰 테두리는 자르지 않음
- 흰색 테두리 남음은 범위 밖
